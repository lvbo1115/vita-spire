...
cat: "HepMA-15"
product_description: |
  1. This product is a photosensitive biomaterial derived from heparin, retaining the excellent biocompatibility and cell adhesion properties of its parent material.
  ...
  3. The degree of grafting of this product ranges from 5% to 25%, ensuring reliable photo-crosslinking performance.
...
concentration: "1. The recommended concentration of this product is 5-20%(w/v).The dissolution temperature is 30-37 centigrade, and the solution can be filtered and sterilized through a 0.22um filter.
