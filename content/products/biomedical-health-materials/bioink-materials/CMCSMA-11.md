...
cat: "CMCSMA-11"
product_description: |
  1. This product is a photosensitive biomaterial derived from carboxymethyl chitosan, retaining the excellent biocompatibility and cell adhesion properties of its parent material.
  ...
  3. The degree of grafting of this product ranges from 15% to 35%, ensuring reliable photo-crosslinking performance.
...
concentration: "1. The recommended concentration of this product is 2%-3% (W/V). The dissolution temperature is 30-40 centigrade, and the solution can be filtered and sterilized through a 0.22um filter.
