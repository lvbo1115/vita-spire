...
cat: "CSMA-09"
product_description: |
  1. This product is a photosensitive biomaterial derived from chondroitin sulphate, retaining the excellent biocompatibility and cell adhesion properties of its parent material.
  ...
  3. The degree of grafting of this product ranges from 25% to 45%, ensuring reliable photo-crosslinking performance.
...
concentration: "1. The recommended concentration of this product is 5%-10% (W/V). The dissolution temperature is 40-50 centigrade, and the solution can be filtered and sterilized through a 0.22um filter.
