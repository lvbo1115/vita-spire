...
cat: "SFMA-12"
product_description: |
  1. This product is a photosensitive biomaterial derived from silk fibroin, retaining the excellent biocompatibility and cell adhesion properties of its parent material.
  ...
  3. The degree of grafting of this product ranges from 70% to 90%, ensuring reliable photo-crosslinking performance.
...
concentration: "1. The recommended concentration of this product is 20%-30% (W/V). The dissolution temperature should below 40 centigrade, and the solution can be filtered and sterilized through a 0.22um filter.
